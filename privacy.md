# RouteCraft Privacy Policy

**Last updated: 8th of April 2026**

Hi! I'm Mark, the creator of RouteCraft. This policy explains what data RouteCraft collects, why, and what your rights are.
...
- Photos, contacts, browsing history, or advertising identifiers
- Health or fitness data from Apple Health or any other source
- Crash reports or analytics about how you use the app

## How I use it

I use your data only to make the app work:
- Email and password let you sign in.
- Your avatar shows up in the app.
- Your saved routes are shown to you in your library and can be exported as GPX files for use in other apps (Strava, Garmin, etc.).
- Your starting location is sent to third-party services to generate routes. I never store your location separately from the routes you explicitly save.

I do not sell, rent, or share your data with anyone for marketing or any other purpose.
...
RouteCraft is not intended for children under 13. I don't knowingly collect data from anyone under 13.

## Changes to this policy

If I update this policy, I'll change the "Last updated" date at the top. Substantive changes will be noted in the app or via email if I have your address.
